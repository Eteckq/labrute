...
const Server = {
  ...
  Brute: {
    ...
    sacrifice: (name: string) => Fetch<{ gold: number, newBrute: HookBrute }>(`/api/brute/${name}/sacrifice`, {}, 'GET'),
    ...
    rankUp2: (name: string) => Fetch<never>(`/api/brute/${name}/rank-up2`),
    ...
    rerollCurrentChoices: (name: string) => Fetch<never>(`/api/brute/${name}/reroll-choices`),
